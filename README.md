...
```javascript
import isProbabilityArray from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-probability-array@v0.2.1-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { objects, primitives } from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-probability-array@v0.2.1-esm/index.mjs';
```
